...
class Simulate:
    ...
    def sim_various_humidity_issues(self):
        ...
        data_dict = {
            ...
            "3": self.oneday([16.7, 13.6, 25.2, 18.1], [50.0, 42.0, 47.0, 71.0], 10, 97, 26, 35, 2),
            ...
            "6": self.oneday([17.1, 13.6, 26.1, 17.2], [49.0, 61.0, 60.0, 20.0], 0, 0, 24, 72, 2)
        }
    ...
    def sim_various_soil_m_issues(self):
        data_dict = {
            ...
            "2": self.oneday([17.1, 13.1, 26.1, 14.2], [32.0, 20.0, 79.0, 69.0], 0, 97, 24, 30, 2),
            "3": self.oneday([4.1, 1.6, 7.1, 5.2], [69.0, 87.0, 89.0, 71.0], 10, 97, 26, 56, 1),
            "4": self.oneday([16.7, 13.6, 25.2, 18.1], [51.0, 60.0, 65.0, 49.0], 0, 0, 24, 72, 2),
    ...
    def sim_various_light_issues(self):
        data_dict = {
            ...
            "4": self.oneday([16.7, 13.6, 25.2, 18.1], [60.0, 51.0, 65.0, 49.0], 0, 97, 24, 30, 2),
            "5": self.oneday([1.1, 0.6, 8.1, 7.2], [69.0, 87.0, 89.0, 71.0], 0, 1, 24, 25, 1),
            "6": self.oneday([16.7, 13.6, 25.2, 18.1], [51.0, 60.0, 65.0, 49.0], 0, 1, 24, 40, 2)
        }
    ...
    def good_situations(self):
        data_dict = {
            "1": self.oneday([17.1, 13.9, 25.2, 19.2], [71.0, 68.0, 85.0, 80.0], 0, 97, 24, 72, 3),
            "2": self.oneday([17.5, 13.6, 26.4, 21.2], [70.0, 65.1, 86.0, 79.0], 0, 97, 24, 72, 3),
            "3": self.oneday([17.8, 13.9, 27.6, 22.2], [75.0, 66.0, 87.0, 81.0], 10, 97, 26, 25, 3),
            "4": self.oneday([17.9, 13.7, 28.8, 17.2], [70.0, 67.0, 88.0, 82.0], 10, 97, 24, 73, 3),
            "5": self.oneday([17.7, 13.3, 29.1, 19.2], [74.0, 66.0, 89.0, 83.0], 0, 97, 24, 75, 3),
            "6": self.oneday([17.2, 13.2, 25.5, 20.2], [70.0, 68.0, 82.0, 84.0], 0, 97, 24, 74, 3)
        }

        return data_dict

    def more_good_situations(self):
        data_dict = {
            "1": self.oneday([17.1, 13.9, 25.2, 19.2], [70.5, 68.9, 85.0, 80.0], 12, 97, 24, 72, 3),
            "2": self.oneday([17.5, 13.1, 26.4, 21.2], [70.0, 65.1, 86.4, 79.0], 0, 97, 24, 72, 3),
            "3": self.oneday([17.6, 13.9, 27.6, 22.2], [70.1, 66.0, 87.0, 81.0], 10, 97, 26, 25, 3),
            "4": self.oneday([17.9, 13.5, 28.8, 17.2], [70.0, 67.0, 88.5, 82.0], 10, 97, 24, 73, 3),
            "5": self.oneday([17.7, 13.2, 28.1, 19.2], [70.2, 66.5, 89.0, 83.0], 0, 97, 24, 75, 3),
            "6": self.oneday([17.2, 13.2, 25.5, 20.2], [70.0, 68.0, 82.7, 84.0], 24, 97, 24, 74, 3)
        }

        return data_dict

    def some_good_situations(self):
        data_dict = {
            "1": self.oneday([17.1, 13.9, 25.2, 19.2], [70.0, 68.0, 85.0, 80.0], 0, 97, 24, 72, 3),
            "2": self.oneday([17.5, 13.6, 26.4, 21.2], [73.0, 65.0, 86.0, 79.0], 0, 97, 24, 72, 3),
            "3": self.oneday([17.8, 13.9, 27.6, 22.2], [75.0, 66.0, 87.0, 81.0], 10, 97, 26, 25, 3),
            "4": self.oneday([17.9, 13.7, 28.8, 17.2], [70.0, 67.0, 88.0, 82.0], 10, 97, 24, 73, 3),
            "5": self.oneday([17.7, 13.3, 29.1, 19.2], [70.0, 66.0, 89.0, 83.0], 0, 97, 24, 75, 3),
            "6": self.oneday([17.2, 13.2, 25.5, 20.2], [72.0, 68.0, 82.0, 84.0], 0, 97, 24, 74, 3)
        }

        return data_dict

    def very_good_situations(self):
        data_dict = {
            "1": self.oneday([17.1, 13.9, 25.2, 19.2], [71.0, 68.0, 85.0, 80.0], 0, 97, 24, 72, 3),
            "2": self.oneday([17.5, 13.6, 26.4, 21.2], [73.0, 65.0, 86.0, 79.0], 0, 97, 24, 72, 3),
            "3": self.oneday([17.8, 13.9, 27.6, 22.2], [72.0, 66.0, 87.0, 81.0], 10, 97, 26, 25, 3),
            "4": self.oneday([17.9, 13.7, 28.8, 17.2], [71.0, 67.0, 86.0, 82.0], 10, 97, 24, 73, 3),
            "5": self.oneday([17.7, 13.3, 29.1, 19.2], [70.0, 66.0, 89.0, 83.0], 0, 97, 24, 75, 3),
            "6": self.oneday([17.2, 13.2, 25.5, 20.2], [75.0, 62.0, 82.0, 84.0], 0, 97, 24, 74, 3)
        }
